...
* [ ] [Add to nurture issue created](https://gitlab.com/gitlab-com/marketing/digital-marketing-programs/issues/new?issuable_template=MPM-05-add-to-nurture) (*if applicable*) - FMC creates, assigns to FMM and MPM
...
* [ ] [Invitation email issue created](https://gitlab.com/gitlab-com/marketing/digital-marketing-programs/-/issues/new?issuable_template=MPM-03-invitations-reminder) - FMC creates, assigns to FMC, FMM and MPM
* [ ] [Follow up email issue created](https://gitlab.com/gitlab-com/marketing/digital-marketing-programs/issues/new?issuable_template=MPM-04-follow-up-email) (*if applicable*) - FMC creates, assigns to FMC, FMM and MPM
* [ ] [Add to nurture issue created](https://gitlab.com/gitlab-com/marketing/digital-marketing-programs/issues/new?issuable_template=MPM-05-add-to-nurture) (*if applicable*) - FMC creates, assigns to FMM and MPM

Add the team label to indicate the team running the event (Example: Field Marketing, Corporate Marketing) 

/label ~"Marketing Programs" ~"mktg-status::wip" ~"Self-Serve"
```
...
If your video meets the gating criteria, please open an issue (`will link issue template`) for the marketing programs team.
