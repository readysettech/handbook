...
A: Yes, [https://about.gitlab.com/features/github](/features/github) [will go live 2018-03-22]

[https://about.gitlab.com/github](/github) will also redirect to the longer URL and can be used in social, emails, etc.
...
Promotionally, we will make the GitLab CI/CD feature available as part of the Free Tier on GitLab.com through 2019-09-22.
...
A: GitLab CI/CD for external repos, including GitLab CI/CD for GitHub will be available as part of the Free tier of GitLab.com for one-year plus extended six-month (through 2019-09-22). After 2019-09-22 we plan to move the feature to be part of GitLab.com Silver. Note: this is for GitLab.com only - self-hosted customers will only have access in Premium & Ultimate.
...
GitLab.com: Free, Bronze, Silver, and Gold (through 2019-09-22)

GitLab.com Silver, Gold (after 2019-09-22)
...
A: No, GitLab CI/CD for GitHub is being [released and launched](/handbook/marketing/product-marketing/#release-vs-launch) on the same day. As such, it will not be available for customers to use until after GitLab 10.6  is released on 2018-03-22.
